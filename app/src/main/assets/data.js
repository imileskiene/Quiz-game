...
const food = {
  easy: [
    {
      question: "Kur yra Eifelio bokštas?",
      options: ["Londonas", "Berlynas", "Paryžius", "Roma"],
      answer: "Paryžius"
    }
  ],
  medium: [
    {
      question: "Kuri šalis garsėja kanalais ir dviračiais?",
      options: ["Olandija", "Belgija", "Danija", "Švedija"],
      answer: "Olandija"
    }
  ],
  hard: [
    {
      question: "Kuris oro uostas yra didžiausias pagal plotą pasaulyje?",
      options: ["JFK", "Beijing Daxing", "Denver", "Frankfurtas"],
      answer: "Denver"
    }
  ]
};
...
const politics = {
    easy: [
      ...
      {
        question: "Which political party is often represented by the color blue in the U.S.?",
        options: ["Republican", "Democratic", "Green", "Libertarian"],
        answer: "Democratic"
      },
      {
      ...
      {
        question: "How many branches of government does the U.S. federal government have?",
        options: ["2", "3", "4", "5"],
        answer: "3"
      },
      {
        question: "Who signs bills into law in the United States?",
        options: ["The Senate", "The President", "The Speaker of the House", "The Chief Justice"],
        answer: "The President"
      },
      {
        question: "What is the main job of the legislative branch?",
        options: ["Make laws", "Enforce laws", "Interpret laws", "Review laws"],
        answer: "Make laws"
      },
      {
        question: "What does the U.S. Constitution do?",
        options: ["Declares war", "Protects the rights of citizens", "Elects the President", "Prints money"],
        answer: "Protects the rights of citizens"
      },
      {
      ...
      },
      {
        ...
        options: ["Congress", "The Supreme Court", "The President", "The Senate"],
        answer: "The President"
      },
      {
        question: "What stops one branch of government from becoming too powerful?",
        options: ["Checks and balances", "Voting", "Democracy", "Federalism"],
        answer: "Checks and balances"
      },
      {
        question: "What is the name of the political party with the elephant symbol?",
        options: ["Democratic", "Green", "Republican", "Libertarian"],
        answer: "Republican"
      },
      {
        question: "What is the name of the building where the U.S. Congress meets?",
        options: ["The White House", "The Pentagon", "The Capitol", "The Supreme Court"],
        answer: "The Capitol"
      },
      {
        question: "Who is the head of the UK government?",
        options: ["The King", "The President", "The Prime Minister", "The Chancellor"],
        answer: "The Prime Minister"
      },
      {
        question: "Which of these is a power of the President?",
        options: ["Declare war", "Veto laws", "Interpret laws", "Make laws"],
        answer: "Veto laws"
      },
      {
      ...
      {
        question: "Who makes federal laws in the U.S.?",
        options: ["The President", "Congress", "The Supreme Court", "The Governor"],
        answer: "Congress"
      },
      {
        question: "Which country is known for having the oldest democracy?",
        options: ["United States", "Greece", "United Kingdom", "France"],
        answer: "Greece"
      },
      {
        question: "What is a primary election?",
        options: ["An election held in primary school", "An election to nominate a candidate", "An election for selecting a president", "A type of general election"],
        answer: "An election to nominate a candidate"
      },
      {
        question: "Which document outlines the rights of U.S. citizens?",
        options: ["The Declaration of Independence", "The Constitution", "The Bill of Rights", "The Emancipation Proclamation"],
        answer: "The Constitution"
      },
        {
        question: "Which of these is NOT a branch of the U.S. government?",
        options: ["Legislative", "Executive", "Administrative", "Judicial"],
        answer: "Administrative"
      },
      {
        question: "What does the term 'veto' mean in politics?",
        options: ["Approve a bill", "Reject a bill", "Change a bill", "Debate a bill"],
        answer: "Reject a bill"
      },
      {
        question: "What are the two major political parties in the U.S.?",
        options: ["Republican and Libertarian", "Democratic and Socialist", "Republican and Democratic", "Green and Libertarian"],
        answer: "Republican and Democratic"
      },
      {
      ...
      {
        question: "What is the purpose of a political campaign?",
        options: ["To raise money for charities", "To win an election", "To create new holidays", "To plan community events"],
        answer: "To win an election"
      },
      {
          question: "What is the role of the Supreme Court?",
          options: ["To make laws", "To enforce laws", "To interpret laws", "To elect the President"],
          answer: "To interpret laws"
        },
        {
          question: "What is a democracy?",
          options: ["A government ruled by one person", "A government ruled by the military", "A government where citizens have a voice", "A government ruled by a small group"],
          answer: "A government where citizens have a voice"
        },
        {
          question: "What is the name of the U.S. legislative branch?",
          options: ["The Parliament", "The Congress", "The Assembly", "The Senate"],
          answer: "The Congress"
        },
        {
          question: "Who was the first President of the United States?",
        ...
        {
          question: "What does the word 'constitution' mean?",
          options: ["A country's history book", "A set of rules and principles for a country", "A type of building", "A form of currency"],
          answer: "A set of rules and principles for a country"
        },
        {
          question: "What is the name of the current Prime Minister of Canada?",
          options: ["Joe Biden", "Justin Trudeau", "Emmanuel Macron", "Rishi Sunak"],
          answer: "Justin Trudeau"
        },
        {
          question: "Which of these countries has a monarchy?",
          options: ["France", "United States", "United Kingdom", "Germany"],
          answer: "United Kingdom"
        },
        {
          question: "What is the name of the lower house of the U.S. Congress?",
          options: ["The Senate", "The House of Representatives", "The Parliament", "The Assembly"],
          answer: "The House of Representatives"
        },
        {
          question: "How long is one term for a U.S. Senator?",
          options: ["2 years", "4 years", "6 years", "8 years"],
          answer: "6 years"
        },
        {
          question: "What is the role of the Vice President of the U.S.?",
          options: ["To be the head of the Senate", "To lead the Supreme Court", "To be the head of the House of Representatives", "To lead the White House staff"],
          answer: "To be the head of the Senate"
        },
        {
              question: "What is the purpose of voting in a democracy?",
              options: ["To have fun", "To choose leaders", "To get free things", "To protest"],
              answer: "To choose leaders"
            },
            {
              question: "What does 'federal' mean in terms of government?",
              options: ["National", "Local", "International", "State"],
              answer: "National"
            },
            {
              question: "What is the name of the U.S. political party often represented by the color red?",
              options: ["Democratic", "Republican", "Green", "Libertarian"],
              answer: "Republican"
            },
            {
              question: "What is the main role of the media in a democracy?",
              options: ["To entertain people", "To control the government", "To inform citizens", "To sell products"],
              answer: "To inform citizens"
            },
            {
              question: "What is the term for a change made to the U.S. Constitution?",
              options: ["A bill", "A law", "An amendment", "A decree"],
              answer: "An amendment"
            },
            {
              question: "Which branch of the U.S. government enforces laws?",
              options: ["Legislative", "Executive", "Judicial", "Administrative"],
              answer: "Executive"
            },
            {
              question: "What is a person called who runs for political office?",
              options: ["A civilian", "A politician", "A candidate", "A voter"],
              answer: "A candidate"
            },
            {
              question: "What is the name of the political system where power is shared between the national and state governments?",
              options: ["Communism", "Federalism", "Monarchy", "Socialism"],
              answer: "Federalism"
            },
            {
              question: "What is the term for a government that is ruled by one person with absolute power?",
              options: ["Democracy", "Monarchy", "Dictatorship", "Oligarchy"],
              answer: "Dictatorship"
            },
            {
              question: "What is the name of the document that the Declaration of Independence declared independence from?",
              options: ["France", "Spain", "Great Britain", "Russia"],
              answer: "Great Britain"
            },
            {
              question: "What is the purpose of a political debate?",
              options: ["To settle arguments", "To inform voters", "To create new laws", "To declare war"],
              answer: "To inform voters"
            },
            {
              question: "Which branch of the U.S. government can declare war?",
              options: ["Executive", "Legislative", "Judicial", "Military"],
              answer: "Legislative"
            },
            {
              question: "What is the main purpose of a political party?",
              options: ["To elect members to office", "To make people angry", "To organize events", "To control the news"],
              answer: "To elect members to office"
            },
            {
              question: "What is the name for the process of choosing a leader by votes?",
              options: ["Election", "Nomination", "Appointment", "Selection"],
              answer: "Election"
            }
          ],
      medium: [
          {
            question: "Which U.S. amendment provides the right to free speech?",
          ...
          {
            question: "How many total members are there in the U.S. Senate?",
            options: ["50", "100", "435", "200"],
            answer: "100"
          },
          {
            question: "Who was the U.K. Prime Minister during World War II?",
            options: ["Neville Chamberlain", "Winston Churchill", "Tony Blair", "David Cameron"],
            answer: "Winston Churchill"
          },
          {
            question: "What is the Electoral College in the U.S.? ",
            options: ["A college for training politicians", "A process for electing the president", "A college for future jurors", "A group that advises the president"],
            answer: "A process for electing the president"
          },
          {
            question: "What is gerrymandering?",
            options: ["A type of political speech", "Manipulating voting district boundaries", "A way to count votes", "A method of campaign financing"],
            answer: "Manipulating voting district boundaries"
          },
          {
            question: "What is the role of the U.S. Speaker of the House?",
            options: ["To lead the Senate", "To lead the House of Representatives", "To advise the President", "To head the Supreme Court"],
            answer: "To lead the House of Representatives"
          },
          {
            question: "What is a filibuster in the U.S. Senate?",
            options: ["A fast vote on a bill", "A tactic to delay or block a vote", "A way to change a bill", "A type of congressional hearing"],
            answer: "A tactic to delay or block a vote"
          },
          {
            question: "What is a pocket veto?",
            options: ["A secret vote", "When the President ignores a bill", "A type of state election", "A vote in a special committee"],
            answer: "When the President ignores a bill"
          },
          {
              question: "What was the significance of the Magna Carta?",
              options: ["It established the first U.S. colony", "It limited the power of the English monarch", "It ended World War I", "It abolished slavery in the U.S."],
              answer: "It limited the power of the English monarch"
          },
          {
              question: "What is a political lobbyist?",
              options: ["Someone who votes for a specific party", "Someone who tries to influence politicians", "Someone who runs for political office", "Someone who organizes political events"],
              answer: "Someone who tries to influence politicians"
          },
          {
              question: "What was the Cold War?",
              options: ["A war in cold weather", "A conflict between the U.S. and Russia", "A war fought in the Arctic", "A war between the U.S. and China"],
              answer: "A conflict between the U.S. and Russia"
          },
          {
              question: "What is the main role of the United Nations?",
              options: ["To make laws for all countries", "To promote peace and cooperation", "To elect world leaders", "To control world trade"],
              answer: "To promote peace and cooperation"
          },
          {
              question: "What is the function of the Federal Reserve in the U.S.?",
              options: ["To print money", "To enforce laws", "To manage the country's currency", "To run the military"],
              answer: "To manage the country's currency"
          },
          {
              question: "What was the purpose of the Declaration of Independence?",
              options: ["To end World War I", "To declare independence from Great Britain", "To elect the first U.S. President", "To write the U.S. Constitution"],
              answer: "To declare independence from Great Britain"
          },
          {
              question: "What is a recall election?",
              options: ["An election to recall past decisions", "An election to remove an elected official", "An election to call for new elections", "An election to review the Constitution"],
              answer: "An election to remove an elected official"
          },
          {
              question: "What is a coalition government?",
              options: ["A government ruled by one party", "A government formed by multiple parties", "A military government", "A government ruled by a religious leader"],
              answer: "A government formed by multiple parties"
          },
          {
              question: "What does the term 'suffrage' mean?",
              options: ["The right to speak", "The right to vote", "The right to assemble", "The right to bear arms"],
              answer: "The right to vote"
          },
          {
              question: "What was the primary focus of the Civil Rights Movement in the U.S.?",
              options: ["To end segregation and discrimination", "To start a new political party", "To change the U.S. currency", "To declare war on another country"],
              answer: "To end segregation and discrimination"
          },
          {
            question: "What is the role of a political caucus?",
            options: ["To elect the President", "To nominate candidates", "To create new laws", "To interpret existing laws"],
            answer: "To nominate candidates"
          },
          {
            question: "What is 'soft money' in U.S. politics?",
            options: ["Money earned from illegal activities", "Unregulated money in political campaigns", "Money given to charities by politicians", "Money used for judicial salaries"],
            answer: "Unregulated money in political campaigns"
          },
          {
            question: "What is a 'super PAC'?",
            options: ["A special government committee", "A political action committee", "An unofficial political party", "An international political alliance"],
            answer: "A political action committee"
          },
          {
            question: "What is the purpose of 'Executive Orders'?",
            options: ["To command the military", "To create temporary laws", "To replace existing laws", "To declare war"],
            answer: "To create temporary laws"
          },
          {
            question: "What was the Marshall Plan?",
            options: ["A military strategy during World War II", "An economic recovery plan for Europe", "A plan to invade China", "A plan to build new U.S. colonies"],
            answer: "An economic recovery plan for Europe"
          },
          {
            question: "What is the significance of the 'Separation of Powers'?",
            options: ["To separate the U.S. from other countries", "To divide government powers between branches", "To separate the U.S. military", "To separate states from federal control"],
            answer: "To divide government powers between branches"
          },
          {
            question: "What is meant by the term 'checks and balances'?",
            options: ["A system for managing the national debt", "A system to prevent tyranny", "A process for hiring government officials", "A type of election monitoring"],
            answer: "A system to prevent tyranny"
          },
          {
            question: "What is the role of the 'Joint Chiefs of Staff'?",
            options: ["To lead the U.S. Congress", "To advise the President on military matters", "To run the U.S. court system", "To head the diplomatic corps"],
            answer: "To advise the President on military matters"
          },
          {
            question: "What is the 'Monroe Doctrine'?",
            options: ["A plan for U.S. westward expansion", "A principle of U.S. foreign policy", "A system of state taxation", "A list of presidential duties"],
            answer: "A principle of U.S. foreign policy"
          },
          {
                question: "What is a referendum?",
                options: ["A vote on a proposed law", "A type of primary election", "A meeting to discuss legislation", "A judicial hearing"],
                answer: "A vote on a proposed law"
              },
              {
                question: "What is the function of the U.S. Congress?",
                options: ["To interpret laws", "To make laws", "To enforce laws", "To elect the President"],
                answer: "To make laws"
              },
              {
                question: "What is the name for the system of government in which the monarch's power is limited?",
                options: ["Absolute Monarchy", "Constitutional Monarchy", "Dictatorship", "Theocracy"],
                answer: "Constitutional Monarchy"
              },
              {
                question: "What does 'bipartisan' mean in the context of politics?",
                options: ["Involving one political party", "Involving two political parties", "Involving multiple political parties", "Not involving any political parties"],
                answer: "Involving two political parties"
              },
              {
                question: "What is the main purpose of the U.S. Supreme Court?",
                options: ["To enforce laws", "To create laws", "To interpret laws", "To elect the President"],
                answer: "To interpret laws"
              },
              {
                question: "What is a midterm election?",
                options: ["An election in the middle of a school year", "An election halfway through a presidential term", "An election in the middle of the month", "An election to choose a new judge"],
                answer: "An election halfway through a presidential term"
              },
              {
                question: "What is the purpose of a political party platform?",
                options: ["To control the media", "To outline the party's beliefs and policies", "To raise money for the party", "To elect candidates to office"],
                answer: "To outline the party's beliefs and policies"
              },
              {
                question: "What is the role of a diplomat?",
                options: ["To manage a business", "To enforce laws", "To represent a country abroad", "To judge court cases"],
                answer: "To represent a country abroad"
              },
              {
                question: "What does the term 'impeachment' mean in U.S. politics?",
                options: ["To appoint someone to office", "To indict a public official", "To make a new law", "To sign a bill into law"],
                answer: "To indict a public official"
              },
              {
                question: "What is a 'caucus' in U.S. politics?",
                options: ["A type of campaign speech", "A meeting of party members", "A court hearing", "A type of political donation"],
                answer: "A meeting of party members"
              },
              {
                question: "What is the significance of the 'Bill of Rights'?",
                options: ["It established the U.S. government", "It limited the power of the monarch", "It lists the basic rights of U.S. citizens", "It ended the Civil War"],
                answer: "It lists the basic rights of U.S. citizens"
              },
              {
                question: "What was the significance of the 'Civil Rights Act of 1964'?",
                options: ["It started World War II", "It ended segregation and discrimination", "It established new states", "It ended the Cold War"],
                answer: "It ended segregation and discrimination"
              },
              {
                question: "What is the role of the 'Federal Bureau of Investigation' (FBI)?",
                options: ["To run the court system", "To investigate federal crimes", "To command the military", "To manage the national debt"],
                answer: "To investigate federal crimes"
              },
              {
                question: "What is meant by the term 'domestic policy'?",
                options: ["Policies concerning foreign relations", "Policies concerning issues within the country", "Policies about the military", "Policies concerning trade with other countries"],
                answer: "Policies concerning issues within the country"
              },
              {
                question: "What is meant by the term 'foreign policy'?",
                options: ["The amount of money a country has", "The way a country interacts with other countries", "The laws that govern a country", "The history of a country"],
                answer: "The way a country interacts with other countries"
              },
              {
                  question: "What is a constituent in politics?",
                  options: ["A government official", "A voter in a district", "A type of law", "A political party leader"],
                  answer: "A voter in a district"
              },
              {
                  question: "What is a lobby in political terms?",
                  options: ["A room where politicians meet", "An attempt to influence legislation", "A type of election", "A special political party"],
                  answer: "An attempt to influence legislation"
              },
              {
                  question: "What is the role of an ambassador?",
                  options: ["To be a judge", "To represent their country in another", "To lead the military", "To make laws"],
                  answer: "To represent their country in another"
              },
              {
                  question: "What is the 'Iron Curtain'?",
                  options: ["A type of military weapon", "The boundary that separated the communist and non-communist countries after WW2", "A trade agreement", "A mountain range"],
                  answer: "The boundary that separated the communist and non-communist countries after WW2"
              },
              {
                  question: "What is meant by 'political asylum'?",
                  options: ["A meeting of politicians", "Protection from political persecution", "A place where elections are held", "A type of political debate"],
                  answer: "Protection from political persecution"
              }
            ],

      hard: [
          {
              question: "What is the name of the theory that supports minimal government intervention in economics?",
              options: ["Keynesianism", "Marxism", "Laissez-faire", "Mercantilism"],
            ...
            {
              question: "What political ideology seeks to establish a classless, stateless society?",
              options: ["Capitalism", "Fascism", "Communism", "Democracy"],
              answer: "Communism"
            },
            {
              question: "Who wrote the political treatise 'Leviathan'?",
              options: ["John Locke", "Thomas Hobbes", "Jean-Jacques Rousseau", "Karl Marx"],
              answer: "Thomas Hobbes"
            },
          {
              question: "What is the 'Iron Triangle' in U.S. politics?",
              options: ["A three-party alliance", "A relationship between agencies, Congress, and interest groups", "A foreign policy strategy", "A type of voting system"],
              answer: "A relationship between agencies, Congress, and interest groups"
          },
          {
              question: "What is 'originalism' in the context of U.S. constitutional interpretation?",
              options: ["Interpreting the Constitution based on current values", "Interpreting the Constitution based on the Founders' intent", "Ignoring the Constitution", "Interpreting the Constitution literally"],
              answer: "Interpreting the Constitution based on the Founders' intent"
          },
          {
              question: "What is the 'necessary and proper' clause of the U.S. Constitution?",
              options: ["A clause about election procedures", "A clause about states' rights", "A clause giving Congress implied powers", "A clause about military authority"],
              answer: "A clause giving Congress implied powers"
          },
          {
              question: "What is 'judicial review'?",
              options: ["The ability to review laws", "The ability of courts to overturn laws", "A type of committee hearing", "A way to appoint judges"],
              answer: "The ability of courts to overturn laws"
          },
          {
              question: "What is the 'spoils system'?",
              options: ["A system of dividing land", "A system of rewarding political supporters with jobs", "A system for reviewing laws", "A system for conducting elections"],
              answer: "A system of rewarding political supporters with jobs"
          },
          {
              question: "What is the 'Miranda warning' related to?",
              options: ["Voting rights", "Rights of the accused", "Freedom of speech", "Property rights"],
              answer: "Rights of the accused"
          },
          {
              question: "What was the 'Bricker Amendment'?",
              options: ["A proposed amendment limiting presidential treaty power", "An amendment related to voting age", "An amendment about freedom of religion", "An amendment about slavery"],
              answer: "A proposed amendment limiting presidential treaty power"
          },
          {
              question: "What is 'amicus curiae'?",
              options: ["A type of jury", "A court reporter", "A friend of the court brief", "A judge's assistant"],
              answer: "A friend of the court brief"
          },
          {
              question: "What is the 'commerce clause' of the U.S. Constitution?",
              options: ["A clause about military authority", "A clause about trade between states", "A clause about religious freedom", "A clause about elections"],
              answer: "A clause about trade between states"
          },
          {
              question: "What is 'dual federalism'?",
              options: ["Two countries with the same government", "Federal and state governments having separate jurisdictions", "Two branches of government sharing power", "One federal government with two capitals"],
              answer: "Federal and state governments having separate jurisdictions"
          },
          {
              question: "What is the 'exclusionary rule'?",
              options: ["A rule about voting rights", "A rule about excluding certain people", "A rule about excluding illegally obtained evidence", "A rule about public assembly"],
              answer: "A rule about excluding illegally obtained evidence"
          },
          {
              question: "What was the significance of 'Marbury v. Madison'?",
              options: ["It established states' rights", "It established judicial review", "It established presidential powers", "It established freedom of speech"],
              answer: "It established judicial review"
          },
          {
              question: "What is 'stare decisis'?",
              options: ["To overturn a past ruling", "To follow a past ruling", "To amend a law", "To create a new law"],
              answer: "To follow a past ruling"
          },
          {
              question: "What is a 'writ of certiorari'?",
              options: ["A written law", "A request for a higher court to review a lower court's decision", "A type of search warrant", "A document related to voting"],
              answer: "A request for a higher court to review a lower court's decision"
          },
          {
              question: "What is 'concurring opinion'?",
              options: ["An opinion that agrees with the majority", "An opinion that disagrees with the majority", "A type of legal contract", "A type of legal document"],
              answer: "An opinion that agrees with the majority"
          },
            {
              question: "Who articulated the concept of 'separation of powers' in modern political thought?",
              options: ["John Locke", "Baron de Montesquieu", "Jean-Jacques Rousseau", "Thomas Hobbes"],
              answer: "Baron de Montesquieu"
            },
            {
              question: "What is the 'Tragedy of the Commons' in political science?",
              options: ["A failed political coup", "Overuse of shared resources", "A type of political debate", "A treaty violation"],
              answer: "Overuse of shared resources"
            },
            {
              question: "What is the 'Two-Thirds Rule' in the U.S. Senate?",
              options: ["The rule to pass a regular bill", "The rule to approve treaties", "The rule for impeachment", "The rule for amending the Constitution"],
              answer: "The rule to approve treaties"
            },
            {
              question: "What is the significance of 'McCulloch v. Maryland'?",
              options: ["Established state supremacy", "Established the supremacy of the federal government", "Limited federal powers", "Abolished slavery"],
              answer: "Established the supremacy of the federal government"
            },
            {
              question: "What does the term 'pork barrel' refer to in U.S. politics?",
              options: ["A type of political scandal", "Funding for local projects", "A type of meat", "A legal document"],
              answer: "Funding for local projects"
            },
            {
              question: "What is meant by 'executive privilege'?",
              options: ["The right to live in the White House", "The right to keep White House documents secret", "A type of presidential pardon", "A type of campaign funding"],
              answer: "The right to keep White House documents secret"
            },
            {
              question: "What is the 'Fourth Branch of Government' often referring to?",
              options: ["The Media", "The Supreme Court", "The Military", "The Federal Reserve"],
              answer: "The Media"
            },
            {
              question: "What is 'logrolling' in political terminology?",
              options: ["Illegal campaign financing", "The practice of trading votes", "A type of political rally", "A type of veto"],
              answer: "The practice of trading votes"
            },
            {
              question: "What is a 'signing statement' in U.S. politics?",
              options: ["A type of bill", "A presidential interpretation of a new law", "A list of new voters", "A document about election results"],
              answer: "A presidential interpretation of a new law"
            },
            {
                    question: "What is the 'Pendleton Act'?",
                    options: ["A bill related to immigration", "A reform to the civil service", "A declaration of war", "A tax reform bill"],
                    answer: "A reform to the civil service"
                  },
                  {
                    question: "What is the 'origination clause' of the U.S. Constitution?",
                    options: ["A clause about where a bill can originate", "A clause about presidential powers", "A clause about voting procedures", "A clause about state borders"],
                    answer: "A clause about where a bill can originate"
                  },
                  {
                    question: "What is the 'elastic clause'?",
                    options: ["A clause about how laws can change", "A clause about congressional authority", "A clause about elastic materials", "A clause about trade"],
                    answer: "A clause about congressional authority"
                  },
                  {
                    question: "What does 'enumerated powers' mean?",
                    options: ["Powers given to the states", "Powers specifically listed in the Constitution", "Powers given to local governments", "Powers not mentioned in the Constitution"],
                    answer: "Powers specifically listed in the Constitution"
                  },
                  {
                    question: "What is the significance of 'Reynolds v. Sims'?",
                    options: ["It established one person, one vote", "It established states' rights", "It established judicial review", "It established freedom of speech"],
                    answer: "It established one person, one vote"
                  },
                  {
                    question: "What is 'unfunded mandate'?",
                    options: ["A law that is not enforced", "A requirement without federal funding", "A type of tax break", "A secret government program"],
                    answer: "A requirement without federal funding"
                  },
                  {
                    question: "What is the 'Bully Pulpit'?",
                    options: ["A special kind of court", "A presidential communication style", "A type of political party", "A type of election system"],
                    answer: "A presidential communication style"
                  },
                  {
                    question: "What does 'coattail effect' mean in politics?",
                    options: ["The influence of a popular candidate", "The length of a political speech", "The length of an election campaign", "A type of political rally"],
                    answer: "The influence of a popular candidate"
                  },
                  {
                    question: "What is 'selective incorporation'?",
                    options: ["Choosing which parts of the Bill of Rights apply to states", "Choosing which parts of the Constitution to follow", "Choosing which candidates to support", "Choosing which laws to enforce"],
                    answer: "Choosing which parts of the Bill of Rights apply to states"
                  },
                  {
                    question: "What is the 'Rule of Four'?",
                    options: ["A rule for voting in Congress", "A rule for granting certiorari", "A rule for declaring war", "A rule about the presidential term"],
                    answer: "A rule for granting certiorari"
                  },
                  {
                    question: "What is a 'writ of habeas corpus'?",
                    options: ["A type of search warrant", "A court order requiring cause for detention", "A type of political debate", "A type of election"],
                    answer: "A court order requiring cause for detention"
                  },
                  {
                    question: "What is the 'establishment clause'?",
                    options: ["A clause about how to establish colonies", "A clause about establishing a religion", "A clause about establishing new laws", "A clause about establishing new courts"],
                    answer: "A clause about establishing a religion"
                  },
                  {
                    question: "What does 'prior restraint' mean in the context of the First Amendment?",
                    options: ["Restraining freedom of speech", "Restraining the press before publication", "Restraining people from voting", "Restraining protests"],
                    answer: "Restraining the press before publication"
                  },
                  {
                    question: "What does the 'clear and present danger' test relate to?",
                    options: ["Gun control", "Freedom of speech", "Drug testing", "Immigration"],
                    answer: "Freedom of speech"
                  },
                  {
                    question: "What is a 'political action committee' (PAC)?",
                    options: ["A committee that makes new laws", "A committee that raises money for elections", "A committee that runs the military", "A committee that judges court cases"],
                    answer: "A committee that raises money for elections"
                  },
                  {
                    question: "What is 'devolution' in the context of political science?",
                    options: ["A war tactic", "Transfer of powers from federal to state level", "A type of tax law", "An economic theory"],
                    answer: "Transfer of powers from federal to state level"
                  },
                  {
                    question: "What does the term 'judicial activism' refer to?",
                    options: ["Judges strictly following precedent", "Judges overturning established law", "Judges refusing to make decisions", "Judges only hearing certain types of cases"],
                    answer: "Judges overturning established law"
                  },
                  {
                    question: "What is the concept of 'executive agreements'?",
                    options: ["Agreements between the President and Congress", "International agreements without Senate approval", "Agreements between states", "Agreements between branches of government"],
                    answer: "International agreements without Senate approval"
                  },
                  {
                    question: "What is meant by 'fiscal federalism'?",
                    options: ["A system of federal courts", "A system of economic control by the states", "The flow of money from federal to state governments", "A system of state taxation"],
                    answer: "The flow of money from federal to state governments"
                  },
                  {
                    question: "What does the term 'preemption' mean in terms of federal law?",
                    options: ["Federal law takes precedence over state law", "State law takes precedence over federal law", "State and federal laws share authority", "No law is in force"],
                    answer: "Federal law takes precedence over state law"
                  }
                ]
};
const finance = [
